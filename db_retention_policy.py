...
with open('RDSbackup.csv', 'w') as csvfile:
...
for region in regions:
	...
	print "##",connection,"##"
	print  "############################################"
	#with open('RDSbackup.csv', 'a') as csvfile:
    #        writer = csv.writer(csvfile, delimiter=',')
	...
	for d in db:
            ...
            if retention_policy > 0:
                ...
                with open('RDSbackup.csv', 'a') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',')
                    writer.writerow([region.name,d.endpoint[0],retention_policy,'Normal'])
            else:
                    print "Backup Retention Policy :: Zero days\n",
                    with open('RDSbackup.csv', 'a') as csvfile:
                        writer = csv.writer(csvfile, delimiter=',')
                        writer.writerow([region.name,d.endpoint[0],retention_policy,'Red'])
